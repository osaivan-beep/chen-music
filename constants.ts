...
// 根據您的 GitHub 截圖，檔案路徑中含有空格，需使用 %20
...
export const INITIAL_CAROUSEL: CarouselImage[] = [
  { id: 'img_1', url: `${GITHUB_RAW_BASE}chen%20p1.jpg`, title: '月光', subtitle: 'Moonlight' },
  { id: 'img_5', url: `${GITHUB_RAW_BASE}chen%20p5.jpg`, title: '在旋律中與自己相遇', subtitle: 'Meeting Yourself in Melody' },
  { id: 'img_3', url: `${GITHUB_RAW_BASE}chen%20p3.jpg`, title: '風 地與水的協奏', subtitle: 'Concerto of Wind, Earth & Water' },
  { id: 'img_6', url: `${GITHUB_RAW_BASE}chen%20p6.jpg`, title: '風與石系列', subtitle: 'Wind & Stone Series' },
  { id: 'img_2', url: `${GITHUB_RAW_BASE}chen%20p2.jpg`, title: '溪語情書', subtitle: 'Love Letters from the Brook' },
  { id: 'img_4', url: `${GITHUB_RAW_BASE}chen%20p4.jpg`, title: '溫暖療癒系', subtitle: 'Warmth & Healing' },
];
...
export const INITIAL_TRACKS: MusicTrack[] = [
  { 
    ...
    coverUrl: `${GITHUB_RAW_BASE}chen%20p1.jpg` 
  },
  { 
    id: 't2', 
    title: '月光 3', 
  ...
  { 
    ...
    coverUrl: `${GITHUB_RAW_BASE}chen%20p5.jpg` 
  },
  { 
    id: 't4', 
    title: '在旋律中與自己相遇 4', 
  ...
  { 
    ...
    coverUrl: `${GITHUB_RAW_BASE}chen%20p3.jpg` 
  },
  { 
    id: 't6', 
    title: '風地與水協奏 3', 
  ...
  { 
    ...
    coverUrl: `${GITHUB_RAW_BASE}chen%20p6.jpg` 
  },
  { 
    id: 't8', 
    title: '風與石系列 4  放手-1', 
  ...
  { 
    ...
    coverUrl: `${GITHUB_RAW_BASE}chen%20p2.jpg` 
  },
  { 
    id: 't10', 
    title: '溪語情書 5', 
  ...
  { 
    ...
    coverUrl: `${GITHUB_RAW_BASE}chen%20p4.jpg` 
  },
  { 
    id: 't12', 
    title: '溫暖療癒系 5', 
